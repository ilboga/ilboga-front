  ...
  experience: [
    {
      ...
      responsibilities: [
        ...
        "Leader of a team of developers and data specialist",
        "Responsible for team growth",
        "Code Quality and Performance Optimization",
        "Deliver technology roadmap",
      ],
    },
    {
      company: "Promemoria group",
      ...
      responsibilities: [
        ...
        "Ensured usable and accessible webpages accordingly to the standards of W3C / WCAG",
        "Working on adoption of atomic design in the dev team",
      ],
    },
    {
      ...
      responsibilities: [
        "Front end developer",
        "Referent for the developers team",
        "AI and UX consultant",
      ],
    },
    {
      company: "Mobgen",
      position: "PHP developer",
      duration: "Jan 2011 - Jul 2012",
      responsibilities: [
        "High traffic optimization",
        "Coding data/feed import",
        "Mobile support",
        "Security assurance",
      ],
    },
  ...
  education: [
    {
      ...
      degree: "Bachelor of Digital Communication",
      graduationYear: 2009,
    },
  ],
};
